...
import com.eReceipt.app.activities.InvoiceDetailActivity;
 ...
 */
public class PendingInvoiceListFragment extends Fragment implements View.OnClickListener{
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.rel_invoice_item :
                loadInvoiceDetail();
        }
    }

    private void loadInvoiceDetail() {
        Intent loadInvoice_detail = new Intent(getActivity(), InvoiceDetailActivity.class);
        startActivity(loadInvoice_detail);
    }
