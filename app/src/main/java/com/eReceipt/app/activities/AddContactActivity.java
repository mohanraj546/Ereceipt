...
import com.eReceipt.app.fragments.AddContactFragment;
...
public class AddContactActivity extends BaseActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTitle.setText(getResources().getString(R.string.add_cont_title));
        setGravityLeft();
        ...
        loadFragment(addContactFragment, R.id.register_container, "Add Contact");
